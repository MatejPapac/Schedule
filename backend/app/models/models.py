...
# Association table from User-Role capabilites

user_capabilites = db.Table('user_capabilites',
...
class User(db.Model):
    ...
    pasword_hash = db.Column(db.string(128),nullable=False)
    ...
    capable_roles = db.relationship('Role', secondary=user_capabilites,
